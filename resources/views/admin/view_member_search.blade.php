...
@section('content')
<?php $information = DB::table('tb_user')->where('username', $username)->first(); ?>
<div class="container">
    <div class="row">
      @if (session('status'))
      ...
      @endif
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">แก้ไขข้อมูลผู้ใช้งาน {{ $information->username }}</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/save_edit_member_search') }}">
                        {{ csrf_field() }}
